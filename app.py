...
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '7233846991:AAEy0fp_d4zzTVQfD0MflnYwTgU9Cq5f5KM')  # Replace with your bot token
...
if __name__ == '__main__':
    setup_bot()
    # Set webhook
    application.bot.set_webhook(url=f"https://chat-bot-syvw.onrender.com/{TOKEN}")
